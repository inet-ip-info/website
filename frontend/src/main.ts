...
const translations = {
  en: {
    ...
    "home.moreToolsText": "From IP lookup to calculation, country IPv4 lists, and an in-browser CLI. Pick the tool you need.",
  ...
  ja: {
    ...
    "home.cliText": "シェルスクリプト、プロビジョニング、監視、インシデント対応のいずれからも、同じサービスをそのまま利用できます。",
    "home.moreToolsTitle": "管理者向けツール",
    "home.moreToolsText": "IP 調査から計算、国別 IPv4 リスト、ブラウザ上の CLI まで。目的のツールへどうぞ。",
    ...
    "command.current.note": "末尾に改行を付けたプレーンテキストのレスポンス。",
  ...
  "zh-Hans": {
    ...
    "home.readableTitle": "GeoIP 揭示的访问背景",
    ...
    "home.moreToolsText": "从 IP 调查到计算、国家 IPv4 列表，再到浏览器内 CLI。选择你需要的工具。",
  ...
  ko: {
    ...
    "home.readableTitle": "GeoIP로 보이는 접속의 배경",
    "home.readableText":
    ...
    "home.moreToolsText": "IP 조회부터 계산, 국가별 IPv4 목록, 브라우저 내 CLI까지. 필요한 도구를 골라 보세요.",
  ...
  es: {
    ...
    "home.readableTitle": "Lo que GeoIP revela sobre el acceso",
    "home.readableText":
    ...
    "home.moreToolsText":
      "De la consulta de IP al cálculo, listas IPv4 por país y una CLI en el navegador. Elige la herramienta que necesites.",
  ...
  fr: {
    ...
    "home.readableTitle": "Ce que GeoIP révèle sur les accès",
    "home.readableText":
    ...
    "home.moreToolsText":
      "De la recherche d'IP au calcul, aux listes IPv4 par pays et à une CLI dans le navigateur. Choisissez l'outil qu'il vous faut.",
  ...
  de: {
    ...
    "home.readableTitle": "Was GeoIP über Zugriffe verrät",
    "home.readableText":
    ...
    "home.moreToolsText":
      "Von der IP-Abfrage über Berechnung und länderbasierte IPv4-Listen bis zur CLI im Browser. Wählen Sie das passende Werkzeug.",
  ...
  "pt-BR": {
    ...
    "home.readableTitle": "O que o GeoIP revela sobre o acesso",
    "home.readableText":
    ...
    "home.moreToolsText": "Da consulta de IP ao cálculo, listas IPv4 por país e uma CLI no navegador. Escolha a ferramenta que precisar.",
